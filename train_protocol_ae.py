...
CHANNELS_LATENT   = 16  # Cuello de botella latente (Espacio del ADN / Entrada del NCA)
...
def main():
    ...
    for epoch in range(config.epochs):  # Número de épocas
        ...
        torch.save(ae_model.state_dict(), f"ae5.1_checkpoint_ep{epoch+1}.pth")
